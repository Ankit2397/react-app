...
const Signin = (Props) =>{
  ...
  return (
   ...
   <div> 
         ...
         <div className="w-full py-0 px-[15px] max-w-[1300px] my-0 mx-auto">  
           ...
           <form onSubmit={getFormData()}>        <div className="fixed top-1/2 max-w-[400px] border-2 border-black max-h-[320px] min-w-[200px] min-h-[200px] w-full h-full left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-[5px] p-4 py-4 z-10"> 
  ...
  <div className="flex flex-col gap-2"><label>Email</label>
   ...
   <button type="submit" className="bg-green-500 py-2 px-3 rounded-[5px] text-white">Sign In</button>
   </div>
        </div>
        </form>
