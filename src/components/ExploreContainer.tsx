...
const ExploreContainer: React.FC<ContainerProps> = ({ name }) => {
  ...
  return (
    <div className="container">
      ...
      <h2 className="ion-padding-top">Sea Turtle</h2>
    ...
    <h2 className="ion-text-uppercase ion-text-center">Rhinoceros</h2>
    ...
    <h2 className="ion-justify-content-center ion-align-items-center">Dolphin</h2>
